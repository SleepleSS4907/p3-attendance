...
# --- 2. ฐานข้อมูลรายชื่อนักเรียนชั้น ป.3 (แก้ไขคนที่ 8 ถูกต้องแล้ว) ---
students_list = [
    ...
    {"เลขที่": 8, "ชื่อ": "เด็กหญิงวราริน มะลิวัน"}, # แก้คีย์จาก "_______" เป็น "ชื่อ" เรียบร้อยครับคุณครู
...
timetable = {
    0: ["ภาษาไทย", "วิทยาศาสตร์", "ศิลปะ", "ลดเวลาเรียน", "สุขศึกษา"], # วันจันทร์
    1: ["English", "คณิตศาสตร์", "การงาน", "สังคม", "แนะแนว"],       # วันอังคาร
    2: ["ภาษาไทย", "English", "คณิตศาสตร์", "ลูกเสือ", "สังคม", "English"], # วันพุธ
    3: ["ภาษาไทย", "English", "English", "วิทยาศาสตร์", "หน้าที่พลเมือง"], # วันพฤหัสบดี
    4: ["English", "คณิตศาสตร์", "ประวัติ", "ลดเวลาเรียน", "ชุมนุม"]     # วันศุกร์
}
...
# ตรวจสอบวันในสัปดาห์ด้วยระบบตัวเลข (0 = จันทร์, 6 = อาทิตย์)
...
if st.button("🚀 อัปเดตข้อมูลลงชีต ป.3 'เช็คชื่อรายวัน'", type="primary", use_container_width=True):
    ...
    if sheet:
        try:
            ...
            if col_index:
                # อัปเดตข้อมูลลงตามแถวจริง (เลขที่ 1 อยู่แถวที่ 2 จนถึงเลขที่ 12 อยู่แถวที่ 13)
